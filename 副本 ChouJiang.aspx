<%@ page language="C#" autoeventwireup="true" inherits="ChouJiang, App_Web_0cuiirgj" %>
...
<body oncontextmenu="window.event.returnValue=false;">
	...
	<div class="main">
		...
		<div class="ra-list">
			<i>请选择奖项：</i>
			<input type="radio" id="r0" class="ra" name="jx" value="tex"/>特等奖
			...
			<input type="radio" id="r5" class="ra" name="jx" value="five" />幸运奖
		</div>
		<div class="current-div">
			<input type="text" name="texes" value="" id="texes" />
			<input type="text" name="current" value="" id="current" />
			<input type="hidden" name="rrss" value="" id="rrss" />
			<div id="list-phones">
