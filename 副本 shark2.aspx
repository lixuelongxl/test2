<%@ page language="C#" autoeventwireup="true" inherits="shak2, App_Web_o15enunv" %>
...
.list li  {overflow:hidden; display:block; padding:2px; border-bottom:1px dotted #000;}
.item-time {float:right; width:75px; text-align:center; height:60px; line-height:60px; color:white; font-size:80%; opacity:0.5;}
.item-intro {color:#F8F8F8; margin-left:5px; margin-top:2px;margin-bottom:5px;text-align: left;}
.item-intro h3 {font-size:110%;font-weight:bold; margin-bottom:0px; width:95%; white-space:nowrap; word-break:keep-all; overflow:hidden;color:#3B577D; }
.item-intro p {color:black;font-size:100%; opacity:0.8; width:100%; }
#shakeInfo p{color:white;}
...
<body class="activity-lottery-winning" style="background:  #1d1d1d no-repeat top;">
    ...
    <img id="shakehideimg" src="images/shakehideimg.png" style="width:320px;"/>
     ...
     <div id="halftop" style=" text-align: center; height:50.15%;background:#4c4c4c; width: 100%;position: fixed;top: 0px;">
       ...
       <img id="halftopimg" src="images/shake_logo_up.png"style="position: absolute;bottom: 0px;display: block;margin: auto;width: 124px;" />
        ...
        <div id="shakeInfo" style=" position: fixed; top: 10px;  text-align: left; width:300px;float: right; right: -250px;">
     
            <div class="boxcontent boxyellow" style=" background-color: #3a3a3a; position: relative; top: 0px; left: 42px; ">
                <div class="box">
                    ...
                    <p id="desc" style="margin-left: 15px;"></p>
                    <a href="http://mp.weixin.qq.com/mp/appmsg/show?__biz=MjM5MDU0NTE2MQ==&appmsgid=10000039&itemidx=1&sign=ea9f743280ec13de99cbea87164fb969#wechat_redirect" target="_blank" class="page-url-link" style="color: orange;margin-left: 15px;">技术支持：fmRadio8>></a>
                  
                </div>
            </div>
               <img src="images/btn_bg.png" style=" position: relative; top: -223px;  "/>
        </div>
       ...
       <div id="prizelist" style=" width: 100%; position: fixed; top:10000px ">
        ...
        <div style="height:1000px;background-color: #F8F8F8;top: -25px;position: relative;"> 
         <div id="listheader">
         <p >我的中奖纪录</p>
          <p id="fillinfo" style="font-size:1.2em ;height:40px"><a href= "" style="color:orange">填写领奖信息></a></p>
          </div>
         <ul class="list" >
...
<div class="boxcontent boxyellow" id="result" style="display:none; z-index: 1001;width:90%;position: fixed;top: 100px;">
                <div class="box">
                    <div class="title-orange" style="text-align: left;">
                        <span>恭喜您中奖了</span></div>
                    <div class="Detail">
                        <p style="text-align: left;">
                            您中了：<span class="red" id="prizetype"> </span>
                        </p>
                        <p>
                            <input class="pxbtn" name="提 交" id="save-btn" type="button" value="确定">
                        </p>
                    </div>
                </div>
            </div>
